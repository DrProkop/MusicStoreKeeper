...
namespace Common
{
    public interface IImageCollectionManager
    {
        ...
        bool RefreshImageDirectory(ICollection<ImageData> imageDataCollection, int ownerId, string directoryPath);
        ...
        /// <param name="ownerId">Id of imageDataCollection owner.</param>
        /// <param name="directoryPath">Directory to check.</param>
        void DeleteDuplicateImagesFromDirectoryAndDb(ICollection<ImageData> imageDataCollection, int ownerId, string directoryPath);
